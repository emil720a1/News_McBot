...
public class SubscriptionRepository : ISubscriptionRepository
{
    ...
    public async Task<bool> IsSubscribedAsync(Guid userId, string topic, CancellationToken cancellationToken)
    {
        return await _dbContext.Subscriptions
            .AnyAsync(s => s.UserId == userId && s.Topic == topic, cancellationToken);
    }

    public async Task<IEnumerable<Subscriptions>> GetByUserIdAsync(Guid userId, CancellationToken cancellationToken)
    {
        return await _dbContext.Subscriptions
    ...
    public async Task<Subscriptions?> GetByIdAsync(Guid id, CancellationToken cancellationToken)
    {
        return await _dbContext.Subscriptions
